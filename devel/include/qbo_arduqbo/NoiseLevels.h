// Generated by gencpp from file qbo_arduqbo/NoiseLevels.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::qbo_arduqbo::NoiseLevels_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qbo_arduqbo::NoiseLevels_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_arduqbo::NoiseLevels_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_arduqbo::NoiseLevels_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_arduqbo::NoiseLevels_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_arduqbo::NoiseLevels_<ContainerAllocator> const>
  : TrueType
  { };

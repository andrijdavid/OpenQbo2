// Generated by gencpp from file qbo_arduqbo/TestRequest.msg
// DO NOT EDIT!


#ifndef QBO_ARDUQBO_MESSAGE_TESTREQUEST_H
#define QBO_ARDUQBO_MESSAGE_TESTREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::qbo_arduqbo::TestRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::qbo_arduqbo::TestRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::qbo_arduqbo::TestRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qbo_arduqbo::TestRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_arduqbo::TestRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_arduqbo::TestRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_arduqbo::TestRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_arduqbo::TestRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::qbo_arduqbo::TestRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::qbo_arduqbo::TestRequest_<ContainerAllocator>&)
  {}
};
...
#endif // QBO_ARDUQBO_MESSAGE_TESTREQUEST_H

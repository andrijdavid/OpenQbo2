// Generated by gencpp from file qbo_face_msgs/TrainRequest.msg
// DO NOT EDIT!


#ifndef QBO_FACE_MSGS_MESSAGE_TRAINREQUEST_H
#define QBO_FACE_MSGS_MESSAGE_TRAINREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::qbo_face_msgs::TrainRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::qbo_face_msgs::TrainRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::qbo_face_msgs::TrainRequest_<ContainerAllocator>& v)
  {
    s << indent << "update_path: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.update_path);
  }
};
...
#endif // QBO_FACE_MSGS_MESSAGE_TRAINREQUEST_H

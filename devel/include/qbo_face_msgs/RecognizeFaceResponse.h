// Generated by gencpp from file qbo_face_msgs/RecognizeFaceResponse.msg
// DO NOT EDIT!


#ifndef QBO_FACE_MSGS_MESSAGE_RECOGNIZEFACERESPONSE_H
#define QBO_FACE_MSGS_MESSAGE_RECOGNIZEFACERESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::qbo_face_msgs::RecognizeFaceResponse_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
...
#endif // QBO_FACE_MSGS_MESSAGE_RECOGNIZEFACERESPONSE_H

...
"""autogenerated by genpy from qbo_face_msgs/FacePosAndDist.msg. Do not edit."""
import sys
...
class FacePosAndDist(genpy.Message):
...
"""
  ...
  _slot_types = ['std_msgs/Header','float32','float32','float32','int32','int32','bool','string']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3f2iB().pack(_x.u, _x.v, _x.distance_to_head, _x.image_width, _x.image_height, _x.face_detected))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.u, _x.v, _x.distance_to_head, _x.image_width, _x.image_height, _x.face_detected,) = _get_struct_3f2iB().unpack(str[start:end])
      ...
      if python3:
        self.type_of_tracking = str[start:end].decode('utf-8')
      else:

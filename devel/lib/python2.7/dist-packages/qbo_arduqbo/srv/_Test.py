...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_b().pack(self.SRFcount))
      ...
      _x = self
      buff.write(_get_struct_8B().pack(_x.Gyroscope, _x.Accelerometer, _x.LCD, _x.Qboard3, _x.Qboard1, _x.Qboard2, _x.rightMotor, _x.leftMotor))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.SRFcount,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.Gyroscope, _x.Accelerometer, _x.LCD, _x.Qboard3, _x.Qboard1, _x.Qboard2, _x.rightMotor, _x.leftMotor,) = _get_struct_8B().unpack(str[start:end])

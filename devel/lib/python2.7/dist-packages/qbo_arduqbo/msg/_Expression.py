...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.eyes.header.seq, _x.eyes.header.stamp.secs, _x.eyes.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2H3I().pack(_x.eyes.rightEye, _x.eyes.leftEye, _x.mouth.header.seq, _x.mouth.header.stamp.secs, _x.mouth.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_20B().pack(*self.mouth.mouthImage))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.eyes.header.seq, _x.eyes.header.stamp.secs, _x.eyes.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.eyes.rightEye, _x.eyes.leftEye, _x.mouth.header.seq, _x.mouth.header.stamp.secs, _x.mouth.header.stamp.nsecs,) = _get_struct_2H3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.mouth.mouthImage = _get_struct_20B().unpack(str[start:end])
      self.mouth.mouthImage = list(map(bool, self.mouth.mouthImage))
      return self
